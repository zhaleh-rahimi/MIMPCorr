...
def fit_deepar(train, test, p, q):
    """
    Fits a DeepAR model for multivariate one-step-ahead forecasting (like VARMA extend).
    ...
    Parameters:
        ...
        q (int): Forecast horizon (prediction length, keep 1 for one-step ahead).
    ...
    # Helper: convert DataFrame -> GluonTS ListDataset
    ...
    for t in range(len(test)):
        ...
        step_forecast = [list(pred)[-1] for pred in future_pred]
